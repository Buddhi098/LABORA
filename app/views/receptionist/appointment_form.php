...
<body>
            ...
            <div class="container_2">
                    ...
                    <div class="item_2">
                        ...
                        <div class="section_1">
                            ...
                            <input type="text" name="email" id="" value="<?php echo $data['patient_email']?>" disabled>
                            </div>
                        </div>
                        <div class="section_2">
                            <div class="note">
                    ...
                    <a  class="submit_button submitted" id="nextBtn" style="text-decoration:none;" onclick="onsitePayment()">Submit</a>
            </div>
   ...
   <!-- pop success & error messages -->
    ...
    <script src="<?php echo APPROOT.'/public/js/receptionist/appointment_form.js';?>"></script>
