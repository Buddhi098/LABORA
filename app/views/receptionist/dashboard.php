    ...
    <div class="container_1">
        <div class="grid-container">
            ...
            <div class="grid-item box box-1">
                ...
                <div class="text">
                    <h2><?php echo $data['total_patients'] ?></h2>
                    <p>Total Patients</p>
                </div>
            ...
            <div class="grid-item box box-2">
                ...
                <div class="text">
                    <h2>Rs.<?php echo $data['today_revenue'] ?></h2>
                    <p>Today Revenue</p>
                </div>
                <div class="dot"><i class="fa-solid fa-ellipsis"></i></div>
            </div>
            <div class="grid-item box box-3">
                ...
                <div class="text">
                    <h2><?php echo $data['today_appointment_count'] ?></h2>
            ...
            <div class="grid-item box box-4">
                ...
                <div class="text">
                    <h2><?php echo $data['today_refund_amount'] ?></h2>
                    <p>Total Refund</p>
                </div>
                <div class="dot"><i class="fa-solid fa-ellipsis"></i></div>
            </div>
