...
<body>
    ...
    <div class="container_1">
        <div class="container_2">
            <div class="header">
                <h1><?php echo $data['fullname']?><br><p>You have the option to modify your profile details here.</p></h1>
            ...
            <form id="profileEditForm">
                <div class="form-group horizontal">
                    <div>
                        ...
                        <input type="text" id="name" name="name" placeholder="<?php echo $data['fullname']?>" pattern="[A-Za-z.' ']+" >
                    </div>
                    <div>
  ...
  <script>
    ...
    profileForm.addEventListener('submit', e => {
        ...
        const link = `${baseLink}/labora/patientdashboard/editProfile`;
