...
<body>
    ...
    <div class="table-container">
        <h2><i class="fa-solid fa-calendar-check"></i>Invoice</h2>
        <div class="add">
            <a href="<?php echo URLROOT?>supplier/getorderForm" class="addbtn"><ion-icon name="add"></ion-icon>Create Invoice</a>
        </div>
