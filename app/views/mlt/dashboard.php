...
<body>
    ...
    <div class="container_1">
        <div class="grid-container">
            ...
            <div class="grid-item box box-3">
                ...
                <div class="text">
                    <h2><?php echo $data['get_test_catergory_count']?></h2>
                    <p>Test Category</p>
                </div>
                <div class="dot"><i class="fa-solid fa-ellipsis"></i></div>
            </div>
            <div class="grid-item big-item big-box">
                ...
                <div class="data-box">
                    ...
                    if ($data['review_report']) {
                        foreach ($data['review_report'] as $report) {
                            echo '<div class="data">
    ...
    <script>
        ...
        function renderCalendar() {
            ...
            const link = `${baseLink}/labora/MLT/getHolidaysCalendar/${currentYear}/${currentMonth + 1}`;
            console.log(link);
            fetch(link, {
                method: "GET"
            }).then(res => {
